...
//   const connect = async (wallet: DirectSecp256k1HdWallet, options: Options): Promise<SigningCosmWasmClient> => {
//     const clientOptions = {
//       prefix: options.bech32prefix,
//     };
...
//   const hitFaucet = async (faucetUrl: string, address: string, denom: string): Promise<void> => {
